...
import searchengine.dto.statistics.StatisticsTotal;
...
public class StatisticsServiceImpl implements StatisticsService {
    ...
    public StatisticsResponse getStatistics() {
        StatisticsTotal total = getTotal();
